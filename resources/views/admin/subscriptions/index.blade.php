    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-6">
                <form action="{{ '/admin/subscriptions/search' }}" method="GET">
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-search"><i class="fa fa-search"></i></span>
                        <input type="text" class="form-control" placeholder="Search..." aria-label="Search" aria-describedby="basic-search">
                    </div>
                </form>
            </div>
